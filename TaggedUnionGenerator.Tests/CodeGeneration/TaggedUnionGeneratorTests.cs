    ...
    public class TaggedUnionGeneratorTests
    {
        ...
        public void ShouldGenerateCommonAttributes()
        {
            ...
            var expectedUnionOptionAttributeCode = """
                ...
                {
                    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("TaggedUnionGenerator", "%%VERSION%%")]
        ...
        public void ShouldGenerateValidIntOrBoolUnion()
        {
            ...
            const string code = """
                namespace Ns
                {
                    [TaggedUnion.UnionOption<int>("IntVal")]
                    [TaggedUnion.UnionOption<bool>("BoolVal")]
            ...
            var expectedCode = """
                ...
                {
                    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("TaggedUnionGenerator", "%%VERSION%%")]
                    partial struct IntOrBool : global::TaggedUnion.IUnion<IntOrBool.TypeEnum>
                    {
        ...
        public void ShouldGenerateValidUnionWithComplexTypes()
        {
            ...
            const string code = """
                namespace Ns
                {
                    ...
                    [TaggedUnion.UnionOption<int>("IntVal")]
                    [TaggedUnion.UnionOption<bool>("BoolVal")]
                    [TaggedUnion.UnionOption<ComplexType1>("ComplexType1Val")]
                    [TaggedUnion.UnionOption<ComplexType2>("ComplexType2Val")]
                    public partial struct IntOrBool
                    { }
                }
                """;
        ...
        public void ShouldRaiseErrorOnDuplicatedUnionOptionName()
        {
            ...
            const string code = """
                ...
                {
                    [TaggedUnion.UnionOption<int>("IntVal")]
                    [TaggedUnion.UnionOption<bool>("IntVal")]
                    public partial struct IntOrBool
                    { }
                }
                """;
        ...
        public void ShouldRaiseErrorOnNullOptionName()
        {
            ...
            const string code = """
                namespace Ns
                {
                    [TaggedUnion.UnionOption<int>(null)]
                    [TaggedUnion.UnionOption<bool>("IntVal")]
                    public partial struct IntOrBool
                    { }
                }
        ...
        [Fact]
        public void ShouldGenerateValidBoolOrBoolUnionWithoutCastOperators()
        {
            // language=csharp
            const string code = """
                namespace Ns
                {
                    [TaggedUnion.UnionOption<bool>("BoolVal")]
                    [TaggedUnion.UnionOption<bool>("OtherBoolVal")]
                    public partial struct BoolOrBool
                    { }
                }
                """;
            ...
            var expectedCode = """
                ...
                {
                    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("TaggedUnionGenerator", "%%VERSION%%")]
                    partial struct BoolOrBool : global::TaggedUnion.IUnion<BoolOrBool.TypeEnum>
                    {
                    public enum TypeEnum
                    {
                        BoolVal = 1,
                    ...
                    private readonly bool _boolVal;
                    private readonly bool _otherBoolVal;

                    private BoolOrBool(TypeEnum type, bool boolVal, bool otherBoolVal)
                    {
                        Type = type;
                        _boolVal = boolVal;
                        _otherBoolVal = otherBoolVal;
                    }

                    public static BoolOrBool FromBoolVal(bool boolVal)
                    {
                        return new BoolOrBool(TypeEnum.BoolVal, boolVal, default);
                    }

                    public static BoolOrBool FromOtherBoolVal(bool otherBoolVal)
                    {
                        return new BoolOrBool(TypeEnum.OtherBoolVal, default, otherBoolVal);
                    }
                    ...
                    public bool TryGetOtherBoolVal(out bool otherBoolVal)
                    {
                        if (Type == TypeEnum.OtherBoolVal)
                        {
                            otherBoolVal = _otherBoolVal;
                            return true;
                        }
                        else
                        {
                            otherBoolVal = default;
                            return false;
                        }
                    }


                    public TResult Match<TResult>(Func<bool, TResult> onBoolVal, Func<bool, TResult> onOtherBoolVal)
                    {
                        return Type switch
                        {
                            TypeEnum.BoolVal => onBoolVal(_boolVal),
                            TypeEnum.OtherBoolVal => onOtherBoolVal(_otherBoolVal),
                            _ => throw new InvalidOperationException("Attempted to resolve invalid option type")
                        };
                    }

                    public void Switch(Action<bool> onBoolVal, Action<bool> onOtherBoolVal)
                    {
                        switch (Type)
                        {
                            case TypeEnum.BoolVal : { onBoolVal(_boolVal); break; }
                            case TypeEnum.OtherBoolVal : { onOtherBoolVal(_otherBoolVal); break; }
                            default: throw new InvalidOperationException("Attempted to resolve invalid option type");
                        };
                    }
                    ...
                    public static global::System.Type GetClrType(TypeEnum type)
                    {
                        ...
                        {
                            TypeEnum.BoolVal => typeof(bool),
                            TypeEnum.OtherBoolVal => typeof(bool),
                            _ => throw new InvalidOperationException("Attempted to resolve invalid option type")
                        };
                    }
                }
            ...
            Assert.Collection(runResult.Diagnostics,
                n => n.AssertDiagnosticEquals(DiagnosticSeverity.Warning, "UG0008", "Option types are not unique, disabling generation of implicit cast operators"));
        }
    }
}